...
For an in-depth coverage of Mapper you can read
...
It's fairly easy to recover the shape of this dataset using **tda-mapper**, as you can see in the following code:
